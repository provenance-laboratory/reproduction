# Pre-registration v9 — a proof that was never parsed, and a record whose clock ran backwards
...
Sections 9 and 10 were written **after** v9 was first stamped and signed, because the control suite
